// Central asset config for the hero 3D scene.
// Swap any path below for a real transparent PNG (e.g. "/src/assets/hero/vending-machine.png")
// without touching component code. Placeholder assets are lightweight SVGs so the
...
import cocaCola from "../../assets/hero/coca-cola.png";
